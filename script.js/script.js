document.addEventListener('DOMContentLoaded', () => {
    ...
    const lyrics = [
        { time: 0, text: "biarkan semua manusia" },
        { time: 3, text: "jadi saksi nyata" },
        { time: 6, text: "bahwa Memiliki mu adalah" },
        { time: 11, text: "anugrah terindah untuk" },
        { time: 16, text: "diri ku" },
        { time: 26, text: "selamanya" },
        { time: 30, text: "tak akan sakiti" },
        { time: 35, text: "kau yang ku cinta sepenuh hati" },
        { time: 39, text: "biarkan semua manusia" },
        { time: 42, text: "jadi saksi nyata bahwa" },
        { time: 46, text: "memiliki mu adalah" },
        { time: 50, text: "anugrah terindah untuk" },
        { time: 57, text: "diri ku" },
        { time: 60, text: "...." },
